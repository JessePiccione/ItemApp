...
function buildPagingTools(count) {
    ...
    for (let index = 0; index < 5 && globals.pageNumber + index < pageCount; index++) {
        ...
        label.addEventListener("click", function () {
            setPageNumber(globals.pageNumber + index)
        });
