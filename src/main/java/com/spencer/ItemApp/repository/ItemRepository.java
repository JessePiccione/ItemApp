...
public interface ItemRepository extends CrudRepository<Item, Long> {
    ...
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.id IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countId(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.sku IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countSku(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.date IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countDate(List<LocalDate> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.brand IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countBrand(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.dept IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countDept(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.itemClass IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countClass(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.originalPrice IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countOriginalPrice(List<Double> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.salePrice IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countSalePrice(List<Double> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.active_flag IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countActiveflag(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.imageFile IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countImageFile(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
    @Query(value = "SELECT COUNT(*) FROM item WHERE item.variants IN (:vals) AND item.date >= (:startDate) AND item.date <= (:endDate) AND item.active_flag IN (:flags)", nativeQuery = true)
    long countVariants(List<String> vals, LocalDate startDate, LocalDate endDate, List<String> flags);
